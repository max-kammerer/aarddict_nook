...
public class ArticleViewActivity extends BaseDictionaryActivity {
    ...
    private ArticleView         articleView2;
    ...
    void initUI() {
        ...
        articleView2.setOnScrollListener(new ArticleView.ScrollListener(){
			public void onScroll(int l, int t, int oldl, int oldt) {
				saveScrollPos(l, t);
			}
        });
        ...
        articleView2.getSettings().setJavaScriptEnabled(true);

        articleView.addJavascriptInterface(new SectionMatcher(), "matcher");
        articleView2.addJavascriptInterface(new SectionMatcher(), "matcher");
...
//    articleView2.setWebChromeClient(new WebChromeClient(){
//
//            @Override
//            public boolean onJsAlert(WebView view, String url, String message,
//            		JsResult result) {
...
//        });
        ...
        articleView2.setWebViewClient(new WebViewClient() {
    ...
    private void goToSection(String section) {
    	...
    	if (section == null || section.trim().equals("")) {
            ...
            articleView2.loadUrl(String.format("javascript:scrollToMatch(\"%s\")", section));
    	}
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_DOWN:
                ...
                break;
            case NOOK_PAGE_DOWN_KEY_LEFT: case NOOK_PAGE_DOWN_KEY_RIGHT:
                pageDown();
                break ;
            case NOOK_PAGE_UP_KEY_LEFT: case NOOK_PAGE_UP_KEY_RIGHT:
                pageUp();
                break ;
...
// from kbs - trook.projectsource code.
    ...
    private boolean zoomIn() {        
        ...
        articleView2.zoomIn();
        scale = articleView2.getScale();
        articleView2.setInitialScale(Math.round(scale*100));
        return zoomed;
    }
    ...
    private void showCurrentArticle() {
    	runOnUiThread(new Runnable() {			
			public void run() {		        
                ...
                articleView2.loadDataWithBaseURL("", wrap(a.text), "text/html", "utf-8", null);
			}
		});
    }
    ...
    protected void onPause() {
        ...
        e.putFloat("articleView.scale2", articleView2.getScale());
